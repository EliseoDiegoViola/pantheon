...
var _updateSpecific = function (channel,commands) {
	if(commands.length == 1){
		var com = commands[0];
		console.log("cm update " + paths[com] + " --last --ignorechanges --forced");
		var atenea = exec("cm update " + paths[com] + " --last --ignorechanges --forced");
...
module.exports = function (param) {
	...
	_updateSpecific(channel,param.args);
};